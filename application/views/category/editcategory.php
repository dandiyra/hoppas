					...
					<div class="col-md-12">
						<div class="map-data m-b-50">
							...
							<div class="login-form">
								<form enctype="multipart/form-data" action="<?= base_url('Category/editCat'); ?>"
									method="post">
									<div class="form-group">
										<input type="text" class="form-control form-control-user" id="id_kategori"
											name="id_kategori" placeholder="Id Category" value="<?= $categori['id_kategori'] ?>" hidden>
									...
									<div class="form-group">
										<input type="text" class="form-control form-control-user" id="nama_kategori"
											name="nama_kategori" placeholder="Name Category" value="<?= $categori['nama_kategori'] ?>" required>
									...
									<div class="form-group">
										<input type="text" class="form-control form-control-user" id="urutan"
											name="urutan" placeholder="Urutan" value="<?= $categori['urutan'] ?>" required>
									...
									<button class="au-btn au-btn--block au-btn--green m-b-20" type="submit">Update
										Category</button>
								</form>
							</div>
						</div>
